...
function dispatchRoot($route, $method, $conexion)
{
  switch ($route) {
    ...
    case 'dispatch/getById':
      ...
      //   //dispatch get by id
      // case 'dispatch/searchNumberAnio':
      //   require_once './dispatch/get_dispatch.php';
      //   if ($method === 'GET') {
      //     // Obtener el id del encabezado de la solicitud
      //     $caseNumber = $_SERVER['HTTP_CASENUMBER'];
      //     $caseYear = $_SERVER['HTTP_CASEYEAR'];
      //     $getDispatch = new get_dispatch($conexion, null);
      //     // $getDispatch->searchNumberAnio($caseNumber, $caseYear);
      //     echo json_encode("llegamos a dispatch/searchNumberAnio");
      //   } else {
      //     // Método no permitido para esta ruta
      //     http_response_code(405);
      //     echo json_encode(['message' => 'Method Not Allowed']);
